...
## Figure 1 --------------------------------------------------------------------
paths <- c("./results/SALMA_kept/genus_level/1-Full/",
           "./results/SALMA_kept/species_level/1-Full/",
           "./results/SALMA_kept/genus_level/4-Tropical_Extratropical/Extratropical/",
           "./results/SALMA_kept/genus_level/4-Tropical_Extratropical/Tropical/")
...
ggsave("./figures/supp_figs/RTT_LTT/RJMCMC_kept/backbone.pdf",
       plot = fig1,
       height = 400,
       width = 400,
       units = "mm")

ggsave("./figures/supp_figs/RTT_LTT/RJMCMC_kept/backbone.png",
       plot = fig1,
       height = 400,
       width = 400,
       dpi = 600,
