...
occdf$lng[occdf$locality %in% c("Shapaja (TAR-74)", "Shapaja (TAR-31)", "Shapaja (TAR-22)", "Shapaja (TAR-72)")] <- -76.16
occdf$lat[occdf$locality %in% c("Shapaja (TAR-74)", "Shapaja (TAR-31)", "Shapaja (TAR-22)", "Shapaja (TAR-72)")] <- -6.56

occdf$lng[occdf$locality == "Santa Rosa"] <- -72.76334
occdf$lat[occdf$locality == "Santa Rosa"] <- -9.494167

occdf$lng[occdf$primary_reference ==
            "R. F. Kay, S.F. Vizcaino, and M. S. Bargo, J. M. G. Perry, F. J. Prevosti, J. C. Fernicola. 2008. Two new fossil vertebrate localities in the Santa Cruz Formation (late early – early middle Miocene, Argentina), ~ 51° South latitude. Journal of South American Earth Sciences 25:187-195"] <- -69.14
occdf$lat[occdf$primary_reference ==
            "R. F. Kay, S.F. Vizcaino, and M. S. Bargo, J. M. G. Perry, F. J. Prevosti, J. C. Fernicola. 2008. Two new fossil vertebrate localities in the Santa Cruz Formation (late early – early middle Miocene, Argentina), ~ 51° South latitude. Journal of South American Earth Sciences 25:187-195"] <- -51.07


# occdf$lng[(occdf$state == "Entre Ríos") &
#                (is.na(occdf$lat))] <- -59.20
