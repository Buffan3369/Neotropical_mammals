...
author:
  - "---"
  - Lucas Buffan^1,2^, Fabien L. Condamine^2^, François Pujos^3,4^, Narla S. Stutz ^2,5^, Pierre-Olivier Antoine^2^ and Laurent Marivaux^2^
  - "---"
  ...
  - "^3^Consejo Nacional de Investigaciones Científicas y T ́ecnicas (CONICET), Argentina"
  - "^4^Instituto Argentino de Nivología, Glaciología y Ciencias Ambientales (IANIGLA), CCT-CONICET-Mendoza, Av. Ruiz Leal s/n, ParqueGral, San Martín 5500, Mendoza, Argentina"
  - "^5^Programa de P ́os-Graduaç ̃ ao em Geociˆencias, Universidade Federal do Rio Grande do Sul (PPGGEO UFRGS), Avenida Bento Gonçalves, 9500, 91501-970, Porto Alegre, Brazil"
  - "---"
...
Cleaning was made based on the expertise of F. Pujos, and details of the procedure are available in the `./data_2023/cleaning_Xenarthra/Xenarthra_FP_2.0.xlsx` table, sheet *Cingulata*. Rows highlighted in red (n=261) have been further removed for the rest of the study. Taxon names, ages, localities and formations were updated in red when needed.  
...
*Clenia brevis* was excluded from the *Clenia* genus by Goin and Abello (2013) [@goin2013]. Hence, we rename the genus *aff_Clenia*.
...
*Actestodon* genus was synonimised with *Actestis* [@abello2007].
...
Cleaning was made based on the expertise of F. Pujos, and details of the procedure are available in the `./data_2023/cleaning_Xenarthra/Xenarthra_FP_2.0.xlsx` table, sheet *Pilosa*. Rows highlighted in red (n=180) have been further removed for the rest of the study. Taxon names, ages, localities and formations were updated in red when needed.  
...
Added occurrence from a newly described genus of the Peridolopidae family from the TAR-74 locality of San Martín, named *Peridolopidae_gen_A* [@antoine2021].
...
Cleaning was highly based on Tarquini et al. 2022 [@tarquini2022].
In addition, we removed our single *Argyrolestes peralestinus* occurrence (coll. nb. 176285, [@marshall1978]) as nomen nubidum [@prevosti2018]
