...
## Burn-in dictionary
declare -A burnin1=(
#[SALMA_kept/genus_level/1-Full]=500 [SALMA_kept/genus_level/2-Singleton]=50 [SALMA_kept/genus_level/3-Spatially_scaled]=10 \
...
#		done
		...
		do
			...
			python ~/Documents/GitHub/CorsaiR/Python/parse_Q_rates.py -dir ../results_EXTENDED/$s/$ss/4-Tropical_Extratropical/RJMCMC/$T/Q_SHIFTS -out ../results_EXTENDED/$s/$ss/4-Tropical_Extratropical/RJMCMC/$T/Q_SHIFTS/Parsed_Q_rates.csv
		done
#		## Ecomorphotype
