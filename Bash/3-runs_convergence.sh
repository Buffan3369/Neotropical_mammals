...
do
	...
	do
		...
		do
			...
			Rscript ~/Documents/GitHub/CorsaiR/R/plot_ess.r "$PWD"/../results/$s/$ss/$ana/pyrate_mcmc_logs/ESS_summary.txt "$PWD"/../results/$s/$ss/$ana/pyrate_mcmc_logs/ESS_plot_${type}.png
		done
	done
done
