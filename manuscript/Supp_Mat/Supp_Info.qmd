...
- Dataset S1 (cleaned fossil occurrence dataset with SALMA kept)
- Dataset S2 (cleaned fossil occurrence dataset with SALMA smoothed)
...
The final dataset comprised 3,384 occurrences, including 529 genera and 1,108 identified species (see **Tab. S1** for a more detailed description of the data). Occurrence data can be found in **Datasets S1** and **S2**.
