...
```{r, echo=FALSE}
#| label: figs41
#| fig-cap: Posterior estimate of the shape parameter of the Weibull distribution for the analyses of the Early and late occurrence datasets, with constant extinction rate. 2.5%, 50% and 97.5% quantiles are indicated in the distribution of each parameter by black horizontal lines, respectively from bottom to top.
