...
#| 
tbl <- read.table("../../figures/supp_figs/tables_MBD/HIGHLAT_andes_diff_post_EECO.txt", header = T, sep = "\t")
# Only retain correlations with origination rate
tbl_ext <- tbl[, c(1:5)]
# Turn to bold significant correlations
tbl_ext[1,] <- sapply(tbl_ext[1,], FUN = convert_bold) #self-diversity
...
#| 
tbl <- read.table("../../figures/supp_figs/tables_MBD/HIGHLAT_andes_diff_Oligocene_only.txt", header = T, sep = "\t")
# Only retain correlations with origination rate
tbl_ext <- tbl[, c(1:5)]
# Turn to bold significant correlations
...
**Supp. Table** 14: Size of the different climate zones ('Tropical Affinity') and Dental Ecomorphotypes ('Diet') categories, expressed in number of occurrences, genera and species.
