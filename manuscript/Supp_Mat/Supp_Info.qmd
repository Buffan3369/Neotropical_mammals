...
```{r, echo=FALSE}
#| label: figs3
#| fig-cap: Map of the fossil-bearing localities considered in this study (435 collections). A major part of them are located close to the Andes. Present-day elevation data were taken from Boschman @boschman_andean_2021.
...
knitr::include_graphics(path = "../../figures/supp_figs/andes_geo_strat/figs40_andes.pdf")
```
