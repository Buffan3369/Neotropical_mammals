...
```{r, echo=FALSE}
#| label: figs3
#| fig-cap: "Map of the fossil-bearing localities considered in this study (435 collections). A major part of them are located close to the Andes. Present-day elevation data were taken from Boschman (2021)."
